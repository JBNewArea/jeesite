...
import com.thinkgem.jeesite.modules.ReturnCode;
...
public class ResponseWrapper {
     ...
     * @return
     */
    public static ResponseWrapper saveError(){
    	ResponseWrapper responseWrapper = new ResponseWrapper();  
        responseWrapper.setSuccess(false);  
        responseWrapper.setCode(ReturnCode.FAILED_SAVE.getCode());  
        responseWrapper.setMsg(ReturnCode.FAILED_SAVE.getMsg());  
     ...
     * 数据入库成功
     */
    public static ResponseWrapper saveSuccess(){
    	ResponseWrapper responseWrapper = new ResponseWrapper();  
        responseWrapper.setSuccess(true);  
        responseWrapper.setCode(ReturnCode.SUCCESS_SAVE.getCode());  
        responseWrapper.setMsg(ReturnCode.SUCCESS_SAVE.getMsg());  
        return responseWrapper;  
    } 
