...
<body>
	<ul class="nav nav-tabs">
		...
		<li><a href="${ctx}/project/projectDeclare/form?id=${projectDeclare.id}"><shiro:hasPermission name="project:projectDeclare:edit">${not empty projectDeclare.id?'入库项目修改':'项目手动录入'}</shiro:hasPermission><shiro:lacksPermission name="project:projectDeclare:edit">查看</shiro:lacksPermission></a></li><shiro:hasPermission name="project:projectDeclare:edit">
			<li class="active">
				<a href="${ctx}/project/projectDeclare/batch" >项目批量录入</a>
			</li>
		</shiro:hasPermission>
	</ul><br/>
	<div id="importBox">
		<form id="importForm" action="${ctx}/project/projectDeclare/import" method="post" enctype="multipart/form-data"
