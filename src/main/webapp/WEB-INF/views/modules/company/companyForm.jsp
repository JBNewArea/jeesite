...
<body>
	...
	<form:form id="inputForm" modelAttribute="company" action="${ctx}/company/company/save" method="post" class="form-horizontal">
		...
		<div class="control-group" style="float:right;margin-top:-3%;margin-right:46.5%;">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="registeredCapital" htmlEscape="false" maxlength="100" class="input-xlarge "/>
			</div>
		</div>
		<div class="control-group" style="float:right;margin-top:-3%;margin-right:40%;">
		...
		<div class="control-group" style="float:right;margin-top:-3%;margin-right:16.5%;">
		...
		<div class="control-group" >
			...
			<div class="controls">
				<form:textarea path="remarks" htmlEscape="false" rows="4" maxlength="255" class="textarea required"/>
				<span class="help-inline"><font color="red">*</font> </span>
			</div>
		</div>
